...
public class BillingSms extends AbstractBaseJob {
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        try {
            ...
            iss.billingSms(tableName);

            //是否还有剩余业务数据未处理,如果有,则直接触发下一次执行
            iss.fastTriggerBilling(jobExecutionContext.getJobDetail().getKey(), tableName);
